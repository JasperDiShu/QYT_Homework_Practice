...
# 2020.03.31-Homework--crontab job
...
scheduler.add_job(func=qyt_print, args=['test1', 'test2'], trigger='date', run_date=datetime(2020, 3, 31, 10, 52), id='date调度!测试正常打印!')

# interval: 每隔一段时间执行一次weeks=0 | days=0 | hours=0 | minutes=0 | seconds=0, start_date=None, end_date=None, timezone=None
# scheduler.add_job(func=qyt_print, args=['test1', 'test2'], trigger='interval', seconds=10, start_date=datetime(2020, 3, 31, 10, 27),
#                   end_date=datetime(2020, 3, 31, 10, 28), id='interval调度!测试正常打印!')
